...
const answerListId = document.getElementById("answer-list");
...
submitButton.addEventListener("click", () => {
    ...
    if (parseInt(selectedAnswer.value) === questions[index].correct) {
        score++;
    }

    const correctAnswerIndex = questions[index].correct;
    answerListId.children[correctAnswerIndex].style.backgroundColor = "lightgreen";
